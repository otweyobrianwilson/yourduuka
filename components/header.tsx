...
export default function Header() {
  // Remove scroll-based size changes to prevent jittery behavior
  const isScrolled = false; // Fixed state - always show full size
  
  return (
    <header className="bg-brand-soft border-brand-light border-b sticky top-0 z-40 shadow-elegant">
        ...
        <div className="flex justify-between items-center py-5">
          ...
          <Link href="/" className="flex items-center">
            <div className="flex items-center">
              <div className="bg-brand-primary text-on-primary mr-3 p-3">
                <ShoppingBag className="h-6 w-6" />
              </div>
              <div>
                <h1 className="font-light text-brand-primary japanese-title text-2xl">YourDuuka</h1>
                <p className="text-brand-secondary chinese-accent text-sm mt-1">Premium Footwear</p>
              </div>
            </div>
          </Link>
